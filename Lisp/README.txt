...
Testato su: LispWorks Personal Edition 6.1.1
...
Per eseguire il proprio codice assembler in ambiente Lisp seguire l'esempio:

cl-prompt> (lmc-run  "path_to_file" '(input))
;;; Output

path_to_file è l'indirizzo del file in formato assembly da consultare,
l'indirizzo deve essere assoluto.
